...
class VerifyValidationReportAssumptionsExactTests(unittest.TestCase):
    def test_extra_assumption_fails_verification(self) -> None:
        ...
        try:
            ...
            self.assertIn("INVALID ASSUMPTIONS", result.stdout)
        finally:
