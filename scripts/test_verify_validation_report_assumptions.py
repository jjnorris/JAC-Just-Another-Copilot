...
class VerifyValidationReportAssumptionsTests(unittest.TestCase):
    def test_missing_expected_assumptions_fails_verification(self) -> None:
        ...
        try:
            ...
            self.assertIn("MISSING OR EMPTY ASSUMPTIONS", result.stdout)
        finally:
