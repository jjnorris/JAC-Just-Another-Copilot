...
class VerifyValidationReportNoGapsTests(unittest.TestCase):
    def test_non_empty_not_validated_fails_verification(self) -> None:
        ...
        try:
            ...
            report: dict[str, object] = {
                ...
                "not_validated": ["end-to-end CI integration"],
            ...
            self.assertIn("UNRESOLVED VALIDATION GAPS", result.stdout)
        finally:
