...
class VerifyValidationReportStageSequenceTests(unittest.TestCase):
    def test_out_of_order_validated_stages_fails_verification(self) -> None:
        ...
        try:
            ...
            self.assertIn("INVALID VALIDATED STAGE SEQUENCE", result.stdout)
        finally:
