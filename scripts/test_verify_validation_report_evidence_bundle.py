...
class VerifyValidationReportEvidenceBundleTests(unittest.TestCase):
    def test_missing_core_evidence_link_fails_verification(self) -> None:
        ...
        try:
            ...
            self.assertIn("INVALID EVIDENCE BUNDLE", result.stdout)
            self.assertIn("repo-task-change-outline.json", result.stdout)
        finally:
