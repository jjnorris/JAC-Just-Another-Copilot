...
Use this file when you want to keep JACK in this repository, transplant it into another repository, or compare repo-scoped and user-scoped placement.

## Repo-scoped files this repository ships

These files are committed in this repository and are the primary install shape for JACK:
...
If you are using JACK in this repository, keep the repo-scoped files above together.
They are meant to travel as one set.

## Copying JACK into another repository
