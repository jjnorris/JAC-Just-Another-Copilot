...
This document records the schema families observed among `docs/jacks/hook-contracts/*/hook.json` files in this repository.
...
- event-style:
  - docs/jacks/hook-contracts/session-start/hook.json
  - docs/jacks/hook-contracts/error-occurred/hook.json

- trigger-style:
  - docs/jacks/hook-contracts/tool-guardian/hook.json
  - docs/jacks/hook-contracts/extension-surface-guard/hook.json
  - docs/jacks/hook-contracts/assumption-recorder/hook.json
  - docs/jacks/hook-contracts/context-budgeter/hook.json
  - docs/jacks/hook-contracts/dependency-risk/hook.json
  - docs/jacks/hook-contracts/telemetry-emitter/hook.json
  - docs/jacks/hook-contracts/review-gate/hook.json
  - docs/jacks/hook-contracts/secrets-scanner/hook.json
  - docs/jacks/hook-contracts/structured-output/hook.json
