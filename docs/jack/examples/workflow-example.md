...
Example session using JACK manually:

1. Open `instructions.md`.
2. Run `docs/jack/workflows/intake-and-clarify.md` to classify ambiguity.
3. Fill `docs/jack/templates/correctness-contract.json`.
