...
This repository contains JAC's repo-scoped Copilot files and the longer docs that support them.
...
- use `docs/jac/` for longer rules, rationale, workflows, templates, examples, and support notes
...
- do not present `docs/jac/inventory.json`, Markdown workflows, templates, examples, or hook notes as native runtime features
...
- verify that repo-facing files still agree with the longer docs in `docs/jac/`
