...
- use `docs/jacks/` for longer rules, rationale, workflows, templates, examples, and support notes
...
- do not present `docs/jacks/inventory.json`, Markdown workflows, templates, examples, or hook notes as native runtime features
...
- verify that repo-facing files still agree with the longer docs in `docs/jacks/`
